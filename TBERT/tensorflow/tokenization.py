...
class FullTokenizer(object):
    ...
    def __init__(self, do_lower_case=True):
        self.tokenizer = SentencePieceTokenizer(model_file = MODEL_FILE_PATH["model_file"], do_lower_case=do_lower_case)
        self.vocab = load_vocab(vocab_file = VOCAB_FILES_NAMES["vocab_file"])
